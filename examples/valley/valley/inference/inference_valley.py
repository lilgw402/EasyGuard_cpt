...
if __name__ == "__main__":
    ...
    parser.add_argument("--model-name", type=str, default = '/mnt/bn/yangmin-priv-fashionmm/Data/sk/checkpoints/valley-chinese-7b-lora-product-continue-pretrain-basicdown-pool-5epoch-v2/checkpoint-28000')
    ...
    parser.add_argument("--out_path", type=str, required = False, default = '/mnt/bn/yangmin-priv-fashionmm/Data/sk/continue_data/cp_mllm_output_basic/cp_7b_lora_pool_v1_basicdown_down.txt' )
